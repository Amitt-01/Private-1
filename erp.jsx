...
export default function PremiumERPPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-700 text-gray-100 font-sans">
      ...
      <main className="max-w-6xl mx-auto px-6">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mt-12">
          <div>
            <h2 className="text-4xl md:text-5xl font-extrabold leading-tight">A premium ERP built for modern colleges</h2>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <a href="/erp/module" className="inline-flex items-center gap-2 px-5 py-3 rounded-full bg-gradient-to-r from-yellow-400 to-orange-500 text-black font-semibold shadow-xl transform hover:-translate-y-0.5 transition">Explore Modules</a>
              <a href="/erp/login" className="inline-flex items-center gap-2 px-5 py-3 rounded-full border border-gray-600 text-sm text-gray-200 hover:bg-gray-800 transition">ERP Login</a>
            </div>
          ...
          <div className="relative">
            <div className="rounded-2xl p-6 bg-gradient-to-br from-white/6 to-white/3 backdrop-blur-sm border border-white/10 shadow-2xl">
              ...
              <div className="mt-4 flex items-center gap-3">
                <a href="/erp/login" className="text-sm px-4 py-2 border border-white/10 rounded-md">Open Admin</a>
                <a href="/erp/module" className="text-sm px-4 py-2 rounded-md bg-gradient-to-r from-purple-500 to-pink-500 font-semibold">Open Modules</a>
              </div>
            </div>
